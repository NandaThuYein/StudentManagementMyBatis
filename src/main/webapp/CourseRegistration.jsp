...
<body>
    ...
    <form action="AddCourseServlet" method="post">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" name="courseId" class="form-control" id="id" value="${bean.courseId}" />
            </div>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" name="courseName" class="form-control" id="name" value="${bean.courseName}" />
            </div>
        </div>
        <div class="row mb-4">
